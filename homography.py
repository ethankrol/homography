import cv2
import numpy as np
def homography(image_path, points):
    ...
    base_img = cv2.imread('image_14.png') # Replace with path to base image
    ...
    curr_points = [[256,164],[231, 207],[168,190],[193,151]]
    dst_pts = np.array(curr_points, dtype=np.float32)
